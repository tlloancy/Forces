...
Tu contrôles des unités terrestres, navales et aériennes. Les combats comparent la [b]force[/b] cumulée sur une case — le plus fort capture les pièces ennemies.""",
	"""[b]Les Power[/b] : en occupant des zones ennemies ou en restant passif, tu gagnes ou perds des jetons Power pour créer de nouvelles unités.
